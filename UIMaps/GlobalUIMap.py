...
ODBHomePageMap = dict(
    ODBHomePageMapText = "ONE DAY BATTING",
    ODBLoginUsernameName = "username",
    ODBLoginPasswordName = "password",
    ODBNewsListLinkText = "News List",
    ODBSearchID = "news_heading",
    ODBSearchButtonName = "news_search",
    ODBCols = '//table/tbody/tr/td[2]',
    ODBAdminDropdownID = "fat-menu",
    ODBDropdownMenu = "open",
    ODBLogoutButtonXpath = "//a[1]"
    )
