...
from POMPythonSeleniumWebdriver.pages.BasePage         import BasePage
import unittest
#from nose.plugins.attrib import attr
#from hamcrest                       import *
from POMPythonSeleniumWebdriver.UIMaps.GlobalUIMap     import URLPageList, FooterNavMap, GlobalNavMap
...
class GlobalTest(BaseTestCase, unittest.TestCase):
    ...
    def test_imageCheckTest(self):
        for link in URLPageList:
            #print PythonSeleniumWebdriver_Constants['Base_URL'] + link
